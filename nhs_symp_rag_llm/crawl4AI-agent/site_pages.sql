...
create table site_pages (
    ...
    page_type varchar not null default 'general',  -- Added: 'condition', 'symptom', 'treatment'
...
-- Add an index for page_type
CREATE INDEX idx_page_type ON site_pages (page_type);
